...
> **历史资料（2026-08-03 起不再作为执行规范）**：本文保留 Claude Code 初建时期的设计、
> PAT 和旧运维流程，仅供追溯。当前唯一权威规范是根目录 [`AGENTS.md`](AGENTS.md)，
> 当前操作流程见 [`docs/daily-ops.md`](docs/daily-ops.md)。不得照本文旧 PAT 模板向对话粘贴令牌。
