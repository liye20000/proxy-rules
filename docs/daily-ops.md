...
(V2RayN 用)和 shadowrocket.module / shadowrocket.conf(Shadowrocket 用)。

请帮我完成以下任务:[在这里描述你要做什么]

操作规则:
1. 用 git clone 拉取仓库
2. 修改 proxy-list.txt(只改这个文件,不要碰自动生成的 v2rayn-rules.json / shadowrocket.module / shadowrocket.conf)
